...
The result is `releases/SubmarineRC-v1.3.0.apk`. The supplied APK uses the standard debug signing key and is suitable for sideloading/testing only.

Install with:

```bash
adb install -r releases/SubmarineRC-v1.3.0.apk
```
